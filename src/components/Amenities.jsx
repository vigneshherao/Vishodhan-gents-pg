      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {content.amenities_list &&
            content.amenities_list.map((item, index) => {
              ...
              const gradientClass =
                gradients[item.color_theme] || "from-slate-100 to-slate-200";
                  ...
                  <div className="flex flex-col h-full justify-between relative z-10">
                    ...
                    >
                      <IconComponent
                        size={32}
                        strokeWidth={2.5}
                        className={`text-${item.color_theme}-600`}
                      />
                    </motion.div>

                    <div>
                      <h3
                        className={`text-2xl font-bold mb-2 text-white drop-shadow-sm`}
                      >
                        {item.title}
                      </h3>
